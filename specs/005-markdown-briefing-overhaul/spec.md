...
- **FR-008**: System MUST sort Area groups alphabetically after the "No Area" group.
...
- **Area**: A Things 3 organizational grouping for tasks. Key attributes: name. A task belongs to zero or one Area.
...
- The markdown file naming convention uses the date of generation (e.g., `morning-briefing-2026-04-26.md`).
